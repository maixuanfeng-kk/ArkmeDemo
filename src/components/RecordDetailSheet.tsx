      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-6">
          ...
          {canRecognizeArrangement && (
            <button
              type="button"
              className="mb-4 flex h-11 w-full items-center justify-center gap-1.5 rounded-[8px] bg-primary text-[14px] font-semibold text-on-primary transition active:scale-[0.98]"
              onClick={() => {
                onRecognizeArrangement?.(record);
                onClose();
              }}
            >
              <svg
